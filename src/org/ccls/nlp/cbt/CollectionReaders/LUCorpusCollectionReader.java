...
public class LUCorpusCollectionReader extends CollectionReader_ImplBase {
	...
	public static CollectionReader getCollectionReader(String Dir) throws ResourceInitializationException {
		...
		return CollectionReaderFactory.createCollectionReader(
				LUCorpusCollectionReader.class,
...
//		return mCurrentIndex < 10;
	...
	public void getNext(CAS aCAS) throws IOException, CollectionException {
		...
		System.out.println("LUCorpusCollectionReader.getNext(): " + file.getName());
...
//				continue;
			...
			line = line.replaceAll("<post author=.*>", "");
			line = line.replaceAll("<quote orig_author=.*>", "");
...
//					System.out.println(annMatcher.group(2));
					try{
						annMatcher.appendReplacement(outputBuffer, annMatcher.group(2));
					}catch(Exception e){
						System.out.println("LUCorpusCollectionReader.importCBAnnotationsToCas(): ERROR: " + annMatcher.group(2));
					}
