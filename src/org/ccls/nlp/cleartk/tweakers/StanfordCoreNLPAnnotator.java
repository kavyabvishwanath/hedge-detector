...
public class StanfordCoreNLPAnnotator extends JCasAnnotator_ImplBase {
	...
	public static AnalysisEngineDescription getDescription() throws ResourceInitializationException {
		System.out.println("Inside StanfordCoreCLPAnnotator.getDescription()");
...
//			System.out.println(token.getCoveredText());
		...
		for (CoreMap sentenceAnn : document.get(SentencesAnnotation.class)) {
			...
			if (tree.children().length != 1) {
				System.out.println("StanfordCoreNLPAnnotator.process(): sentence: " + sentence.getCoveredText());
				System.out.println("StanfordCoreNLPAnnotator.process(): tree: " + tree);
		...
		System.out.println("Problem trees: "+problem_trees);
